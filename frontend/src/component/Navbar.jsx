...
const Navbar = () => {
    ...
    return (
        <div className={`dark:bg-slate-900 dark:text-white max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-pink-600 duration-300 transition-all ease-in-out" : ""}`}>
            <div className="navbar bg-base-80 shadow-sm">
                ...
                <div className='navbar-end space-x-3'>
                    ...
                    <div className="hidden md:block">
                        <label className="input rounded-m px-3 py-2">
                            <svg className="h-[1em] opacity-50  dark:text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <g
